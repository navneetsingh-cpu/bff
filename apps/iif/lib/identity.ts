...
/**
 * This app's audience. An assertion the BFF minted for `connect` or `handbook`
 * must not verify here, which is what makes the audience claim worth having.
 */
export const AUDIENCE = 'iif';
