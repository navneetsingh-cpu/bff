...
export default async function ConnectPage() {
  ...
  return (
    <main>
      ...
      <h2>Not built yet</h2>
      <ul className="stub">
        <li>Employee search by name, team and location</li>
        <li>Org chart with reporting lines</li>
        <li>Team pages with on-call and contact details</li>
        <li>Profile editing, gated on <code>connect.admin</code></li>
      </ul>
